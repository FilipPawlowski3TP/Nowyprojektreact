...
const Home = () => {
    return (
        <div className="home">
            <section className="hero d-flex justify-content-center align-items-center text-center" style={{
                backgroundImage: 'url("stronatytulowa.jpg")',
                backgroundSize: 'cover',
                height: '60vh'
            }}>
                <div className="hero-content text-white">
                    <h1 className="display-4">Odkryj perfumy, które mówią za Ciebie</h1>
                ...
                <div className="container text-center">
                    ...
                    <div className="row" >
                        <div className="col-md-4 mb-4" >
                            <div className="card">
                                <img src="/src/assets/sztaba.jpg" className="card-img-top h-25 text-center" alt="Nowy zapach 1" style={{maxHeight: '25em', maxWidth: '15em'}} />
                        ...
                        <div className="col-md-4 mb-4">
                            <div className="card">
                                <img src="/src/assets/vers.jpg" className="card-img-top" alt="Nowy zapach 2" style={{maxHeight: '25em', maxWidth: '15em'}}/>
                                <div className="card-body">
                        ...
                        <div className="col-md-4 mb-4">
                            <div className="card">
                                <img src="/src/assets/hugo.jpg" className="card-img-top" alt="Nowy zapach 3" style={{maxHeight: '25em', maxWidth: '15em'}}/>
                                <div className="card-body">
            ...
            <section className="bestsellers py-5 bg-light">
                <div className="container text-center">
                    ...
                    <div className="row">
                        <div className="col-md-4 mb-4">
                            <div className="card">
                                <img src="/src/assets/dior.jpg" className="card-img-top" alt="Bestseller 1" style={{maxHeight: '25em', maxWidth: '15em'}}/>
                                <div className="card-body">
                        ...
                        <div className="col-md-4 mb-4">
                            <div className="card">
                                <img src="/src/assets/ogien.jpg" className="card-img-top" alt="Bestseller 2" style={{maxHeight: '25em', maxWidth: '15em'}}/>
                                <div className="card-body">
                        ...
                        <div className="col-md-4 mb-4">
                            <div className="card">
                                <img src="/src/assets/ziomal.jpg" className="card-img-top" alt="Bestseller 3" style={{maxHeight: '25em', maxWidth: '15em'}}/>
                                <div className="card-body">
            ...
            <section className="brands py-5">
                <div className="container text-center">
                    ...
                    <div className="d-flex justify-content-center">
                        <img src="/src/assets/valentino.jpg" alt="Marka 1" className="img-fluid me-4" style={{maxHeight: '25em', maxWidth: '15em'}}/>
                        <img src="/src/assets/gucci.jpg" alt="Marka 2" className="img-fluid mx-3" style={{maxHeight: '25em', maxWidth: '15em'}}/>
                        <img src="/src/assets/robot.jpg" alt="Marka 3" className="img-fluid ms-4 " style={{maxHeight: '25em', maxWidth: '15em'}}/>
                    </div>
